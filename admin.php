...
<div class="dashboard">
    ...
    <div class="card">
        ...
        <a href="admin_leave.php">Apply</a>
            ...
            <a href="admin_attendance.php" class="card">
                <i class="fas fa-calendar-alt"></i>
                <h4>View Attendance</h4>
                <p>View and analyse the attendance</p
    </a>
        
        <a href="admin_assign.php" class="card">
                <i class="fas fa-calendar-alt"></i>
                <h4>To assign shifts</h4>
        ...
        <a href="admin_appraisal.php" class="card">
                <i class="fas fa-calendar-alt"></i>
                <h4>appraisal</h4>
                
        </a>
        <a href="admin_view_appraisal.php" class="card">
                <i class="fas fa-calendar-alt"></i>
                <h4>view appraisal</h4>
